...
$$\begin{cases} q_{1,n+1} =& q_{1,n}+h\cdot\dot{q}_{1,n}\\ q_{2,n+1} = & q_{2,n} + h\cdot\dot{q}_{2,n}\\ \dot{q}_{1,n+1} =& \dot{q}_{1,n} - h\dfrac{q_{1,n}}{(q_{1,n}^2 + q_{2,n}^2)^{\frac{3}{2}}}\\ \dot{q}_{2,n+1} =& \dot{q}_{2,n} - h\dfrac{q_{2,n}}{(q_{1,n}^2 + q_{2,n}^2)^{\frac{3}{2}}} \end{cases} $$
